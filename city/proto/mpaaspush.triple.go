...
const (
	...
	GreetServiceName = "city_proto.GreetService"
)
...
const (
	...
	GreetServiceGreetProcedure = "/city_proto.GreetService/Greet"
	// GreetServiceSayHelloProcedure is the fully-qualified name of the GreetService's SayHello RPC.
	GreetServiceSayHelloProcedure = "/city_proto.GreetService/SayHello"
)
...
// GreetService is a client for the city_proto.GreetService service.
...
// NewGreetService constructs a client for the city_proto.GreetService service.
func NewGreetService(cli *client.Client, opts ...client.ReferenceOption) (GreetService, error) {
	conn, err := cli.DialWithInfo("city_proto.GreetService", &GreetService_ClientInfo, opts...)
	if err != nil {
		return nil, err
	}
...
var GreetService_ClientInfo = client.ClientInfo{
	InterfaceName: "city_proto.GreetService",
...
// GreetServiceHandler is an implementation of the city_proto.GreetService service.
