...
const (
	...
	GreetServiceName = "city.proto.mpaas.GreetService"
)
...
const (
	...
	GreetServiceGreetProcedure = "/city.proto.mpaas.GreetService/Greet"
	// GreetServiceSayHelloProcedure is the fully-qualified name of the GreetService's SayHello RPC.
	GreetServiceSayHelloProcedure = "/city.proto.mpaas.GreetService/SayHello"
)
...
// GreetService is a client for the city.proto.mpaas.GreetService service.
...
// NewGreetService constructs a client for the mpaas.GreetService service.
func NewGreetService(cli *client.Client, opts ...client.ReferenceOption) (GreetService, error) {
	conn, err := cli.DialWithInfo("city.proto.mpaas.GreetService", &GreetService_ClientInfo, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *GreetServiceImpl) SayHello(ctx context.Context, req *SayHelloRequest, opts ...client.CallOption) (*SayHelloResponse, error) {
...
var GreetService_ClientInfo = client.ClientInfo{
	InterfaceName: "city.proto.mpaas.GreetService",
	MethodNames:   []string{"Greet", "SayHello"},
...
// GreetServiceHandler is an implementation of the city.proto.mpaas.GreetService service.
	...
	Methods: []server.MethodInfo{
		...
		},
		{
			...
			MethodFunc: func(ctx context.Context, args []interface{}, handler interface{}) (interface{}, error) {
				...
				res, err := handler.(GreetServiceHandler).SayHello(ctx, req)
				if err != nil {
					return nil, err
				}
				return triple_protocol.NewResponse(res), nil
