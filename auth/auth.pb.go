...
func (x *GetIMTokenReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetIMTokenReq) ProtoMessage() {}

func (x *GetIMTokenReq) ProtoReflect() protoreflect.Message {
	mi := &file_auth_auth_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetIMTokenReq.ProtoReflect.Descriptor instead.
func (*GetIMTokenReq) Descriptor() ([]byte, []int) {
	return file_auth_auth_proto_rawDescGZIP(), []int{8}
}

func (x *GetIMTokenReq) GetGrantType() string {
	if x != nil {
		return x.GrantType
	}
	return ""
...
func (x *GetIMTokenReq) GetClientId() string {
	if x != nil {
		return x.ClientId
	}
	return ""
...
func (x *GetIMTokenReq) GetClientSecret() string {
	if x != nil {
...
func (x *GetIMTokenReq) GetCode() string {
	if x != nil {
		return x.Code
	}
	return ""
...
func (x *GetIMTokenResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetIMTokenResp) ProtoMessage() {}

func (x *GetIMTokenResp) ProtoReflect() protoreflect.Message {
	mi := &file_auth_auth_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetIMTokenResp.ProtoReflect.Descriptor instead.
func (*GetIMTokenResp) Descriptor() ([]byte, []int) {
	return file_auth_auth_proto_rawDescGZIP(), []int{9}
}

func (x *GetIMTokenResp) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *GetIMTokenResp) GetExpireTimeSeconds() int64 {
	if x != nil {
		return x.ExpireTimeSeconds
	}
	return 0
...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\x11expireTimeSeconds\x18\x02 \x01(\x03R\x11expireTimeSeconds\"\x81\x01\n" +
	"\rgetIMTokenReq\x12\x1c\n" +
	"\tgrantType\x18\x01 \x01(\tR\tgrantType\x12\x1a\n" +
	"\bclientId\x18\x02 \x01(\tR\bclientId\x12\"\n" +
	"\fclientSecret\x18\x03 \x01(\tR\fclientSecret\x12\x12\n" +
	"\x04code\x18\x04 \x01(\tR\x04code\"T\n" +
	"\x0egetIMTokenResp\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12,\n" +
	...
	"\x05value\x18\x02 \x01(\x05R\x05value:\x028\x012\xf1\x04\n" +
	"\x04Auth\x12N\n" +
	"\rgetAdminToken\x12\x1d.openim.auth.getAdminTokenReq\x1a\x1e.openim.auth.getAdminTokenResp\x12K\n" +
	"\fgetUserToken\x12\x1c.openim.auth.getUserTokenReq\x1a\x1d.openim.auth.getUserTokenResp\x12E\n" +
	"\n" +
	"getIMToken\x12\x1a.openim.auth.getIMTokenReq\x1a\x1b.openim.auth.getIMTokenResp\x12H\n" +
...
var file_auth_auth_proto_goTypes = []any{
	...
	(*GetIMTokenReq)(nil),        // 8: openim.auth.getIMTokenReq
	(*GetIMTokenResp)(nil),       // 9: openim.auth.getIMTokenResp
	(*InvalidateTokenReq)(nil),   // 10: openim.auth.invalidateTokenReq
	(*InvalidateTokenResp)(nil),  // 11: openim.auth.invalidateTokenResp
	(*KickTokensReq)(nil),        // 12: openim.auth.kickTokensReq
	(*KickTokensResp)(nil),       // 13: openim.auth.kickTokensResp
	(*GetExistingTokenReq)(nil),  // 14: openim.auth.GetExistingTokenReq
	(*GetExistingTokenResp)(nil), // 15: openim.auth.getExistingTokenResp
	nil,                          // 16: openim.auth.getExistingTokenResp.TokenStatesEntry
}
var file_auth_auth_proto_depIdxs = []int32{
	16, // 0: openim.auth.getExistingTokenResp.tokenStates:type_name -> openim.auth.getExistingTokenResp.TokenStatesEntry
	...
	8,  // 3: openim.auth.Auth.getIMToken:input_type -> openim.auth.getIMTokenReq
	...
	10, // 6: openim.auth.Auth.invalidateToken:input_type -> openim.auth.invalidateTokenReq
	12, // 7: openim.auth.Auth.kickTokens:input_type -> openim.auth.kickTokensReq
	14, // 8: openim.auth.Auth.getExistingToken:input_type -> openim.auth.GetExistingTokenReq
	...
	9,  // 11: openim.auth.Auth.getIMToken:output_type -> openim.auth.getIMTokenResp
	3,  // 12: openim.auth.Auth.forceLogout:output_type -> openim.auth.forceLogoutResp
	5,  // 13: openim.auth.Auth.parseToken:output_type -> openim.auth.parseTokenResp
	11, // 14: openim.auth.Auth.invalidateToken:output_type -> openim.auth.invalidateTokenResp
	13, // 15: openim.auth.Auth.kickTokens:output_type -> openim.auth.kickTokensResp
	15, // 16: openim.auth.Auth.getExistingToken:output_type -> openim.auth.getExistingTokenResp
